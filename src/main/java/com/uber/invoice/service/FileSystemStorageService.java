...
public class FileSystemStorageService implements StorageService {
	...
	Predicate<MultipartFile> checkIfEmpty = (file) -> {
		return file.isEmpty();
	};
	Predicate<String> checkIfNotSystemFile = (file) -> {
	...
	public void store(MultipartFile file) {
		...
		try {
			...
			if (filename.contains("..")) {
				...
				throw new BaseException("Cannot store file with relative path outside current directory " + filename);
			}
